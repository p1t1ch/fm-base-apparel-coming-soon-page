const config = {
  ...
  shortTitle: 'FM Base Apparel coming soon page',
  // Project description. Used in SEO meta tag and by PWA
  description: 'My solution for Frontend Mentor "Base Apparel coming soon page" challenge',
  ...
  baseUrl: 'https://p1t1ch-fm-base-apparel-coming-soon-page.netlify.app',
